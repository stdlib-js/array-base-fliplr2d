...
```javascript
fliplr2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fliplr2d@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fliplr2d@v0.2.1-umd/browser.js"></script>
```

...
```javascript
fliplr2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fliplr2d@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fliplr2d@v0.1.0-umd/browser.js"></script>
```
